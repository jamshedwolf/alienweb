        ...
        // }}
         className=' pt-[100px] lg:pt-16'>
            ...
            <div className="flex justify-center mx-auto lg:h-screen xl:h-auto xl:py-20  items-center text-center flex-col gap-5 max-w-[1400px]">
                ...
                <button className="flex w-[300px] rounded-full pl-4 py-1 items-center justify-between hover:text-white  hover:border-white hover:bg-[#69AF00] bg-[#33373D] border group gap-4 text-[#B9954F] border-[#B9954F]  px-1"> GreenPapers & Tokenomics <span className="rounded-full bg-[#B9954F] px-2 py-2 border group-hover:bg-white group-hover:text-[#69AF00] group-hover:border-white  border-[#B9954F] text-[#33373D] font-bold ">< IoIosArrowForward/> </span>  </button>
